...
def main(car_path, road_path, cross_path, viz_data_path):
    # car_path = sys.argv[1]
    ...
    dataInfo = open(viz_data_path,'r').read().split('time:')
...
if __name__  ==   "__main__":
    ...
    viz_data_path = 'config//viz_data'
    main(car_path, road_path, cross_path, viz_data_path)
