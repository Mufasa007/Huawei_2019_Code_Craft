...
def main(car_path, road_path, cross_path, answer_path):
    ...
    for i, line in enumerate(answerInfo[1:]):
        if line.strip() == '':
            break
...
# python simulator0.py E:\data\personal\项目\2019华为软件挑战赛\可视化评价系统\huawei2019-with-visualization\config\car.txt E:\data\personal\项目\2019华为软件挑战赛\可视化评价系统\huawei2019-with-visualization\config\road.txt E:\data\personal\项目\2019华为软件挑战赛\可视化评价系统\huawei2019-with-visualization\config\cross.txt E:\data\personal\项目\2019华为软件挑战赛\可视化评价系统\huawei2019-with-visualization\config\answer.txt
